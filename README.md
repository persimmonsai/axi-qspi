...
`src/spi_flash_model.sv` is synthesizable by Vivado and can be used as an
on-FPGA SPI/QSPI flash target. The fixed memory defaults to 1 MiB and aliases
larger flash addresses into that range. Configure it with:
