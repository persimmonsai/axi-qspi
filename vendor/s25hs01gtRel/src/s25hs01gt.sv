...
specify
    ...
    // PATCH (not in original Infineon release): tdevice_CSRBL is used at
    // line ~1399 (`#tdevice_CSRBL STR1V[0] = 1'b1;`) but was never declared
    // as a specparam anywhere in this file -- a real compile blocker
    // (UNDIDN). Added here matching this block's own SPEEDSIM-placeholder
    // convention (every neighboring specparam above is also trivially =1;
    // real values are meant to come from SDF annotation per this block's
    // own comment, not used for this functional smoke test).
    specparam        tdevice_CSRBL           = 1;
...
//Bus cycle state
 ...
 reg  [4:0]  sigres_state;
    ...
    integer k,l,m;
        ...
        SFDP_array[16'h012D] = 8'h23; // Naim
        SFDP_array[16'h012E] = 8'h19; // Naim
        SFDP_array[16'h012F] = 8'h49; // Naim
        // DWORD-13
        ...
        SFDP_array[16'h017A] = 8'h03;
        SFDP_array[16'h017B] = 8'hD0;
...
//         end
        ...
        SFDP_array[16'h0215] = 8'hFF;
        SFDP_array[16'h0216] = 8'h00;
                ...
                case (current_state)
                    ...
                    begin
                        ...
                        begin
                            ...
                            else if (Instruct == WRARG_C_1 && (WRPGEN == 1 || WVREG == 1'b1) &&
                                ~(STCFWR && ~WPNeg_in && ~QUAD_QPI &&
